      ...
      <div className="flex-1 relative">
        ...
        {type === "password" && (
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 text-[#c8c8ff] hover:text-white transition flex items-center justify-center w-8 h-8 rounded-full hover:bg-white/10"
          >
