...
const Sidebar = () => {
  ...
  const [activeTab, setActiveTab] = useState("groups"); // Changed default to "groups" instead of "direct"
  ...
  return (
    <div className="w-80 bg-[#080840] flex flex-col h-full shadow-lg border-r border-white/10">
      {/* Logo and App Name - New Addition */}
      ...
      <div className="px-4 py-3">
        <div className="relative mb-3">
          <Search size={16} className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#c8c8ff]/50" />
          <input
            type="text"
            placeholder="Search"
            value={searchTerm}
        ...
        <div className="flex items-center justify-between">
            ...
            <label className="flex items-center gap-2 text-sm text-[#c8c8ff]/70 cursor-pointer group">
              <div className="relative">
                <input
                  ...
                  className="sr-only"
                />
                <div className={`w-8 h-4 rounded-full transition-colors ${showOnlineOnly ? 'bg-[#070738]' : 'bg-[#c8c8ff]/20'}`}></div>
          ...
          <div className="ml-auto">
            {activeTab === "direct" && (
              <button className="p-2 rounded-lg bg-[#070738]/50 text-[#c8c8ff]/70 hover:text-white transition-colors">
                <UserPlus size={16} />
              </button>
            )}
            {activeTab === "groups" && (
        ...
        <div className="flex items-center">
          ...
          >
            ...
            <div className="min-w-0">
              <h3 className="font-medium text-white truncate text-left">{authUser?.name}</h3>
